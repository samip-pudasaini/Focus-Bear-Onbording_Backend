...
PASS  ./add.test.js
  add
    ✓ adds 2 and 3 to equal 5
    ✓ adds -2 and 3 to equal 1
    ✓ adds 2 and -3 to equal -1
    ✓ adds -2 and -3 to equal -5
    ✓ adds 0 and 5 to equal 5
...
Author 🤖 Focus Bear Intern Review Bot: ❌ Not Approved Required Action: Please
finish the Code Formatting section in clean_code.md with your full Prettier I
can also see your written section is still cut off. I still can't verify the
full task from writing alone.
